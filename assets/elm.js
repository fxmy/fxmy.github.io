...
var _fxmy$fxmygithubio$FxmyBody$comment_entry_view = function (entry) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$src(entry.author.picture),
					_1: {
						ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href(entry.author.url),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(
								{
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'margin', _1: '0 6px'},
									_1: {
										ctor: '::',
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(entry.author.displayName),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											_marcosh$elm_html_to_unicode$ElmEscapeHtml$unescape(entry.content)),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
...
var _fxmy$fxmygithubio$FxmyBody$comment_view = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.content_url, 'blog') ? _elm_lang$html$Html$text('') : A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('comments'),
			_1: {ctor: '[]'}
		},
		A2(_elm_lang$core$List$map, _fxmy$fxmygithubio$FxmyBody$comment_entry_view, model.comment_parsed));
};
	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'margin', _1: '0 48px'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'padding', _1: '12px'},
						_1: {ctor: '[]'}
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(model.content_url),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _fxmy$fxmygithubio$FxmyBody$render = F2(
	function (tag, model) {
		return A2(
			_elm_lang$html$Html$map,
			tag,
...
var _fxmy$fxmygithubio$FxmyBody$initModel = {
	content_url: '',
	content: '',
...
var _fxmy$fxmygithubio$FxmyBody$authorDecoder = A5(
	_elm_lang$core$Json_Decode$map4,
	_fxmy$fxmygithubio$FxmyBody$Author,
	A2(
		_elm_lang$core$Json_Decode$at,
		{
			ctor: '::',
	...
	A2(
		...
		_elm_lang$core$Json_Decode$string));
var _fxmy$fxmygithubio$FxmyBody$CommentEntry = F3(
	function (a, b, c) {
...
var _fxmy$fxmygithubio$FxmyBody$get_content = function (model) {
	var url_full = A2(_elm_lang$core$Basics_ops['++'], 'https://fxmy.github.io/', model.content_url);
	var request = _elm_lang$http$Http$getString(url_full);
	return A2(_elm_lang$http$Http$send, _fxmy$fxmygithubio$FxmyBody$BlogContent, request);
};
			...
			default:
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							comment_parsed: _elm_lang$core$List$reverse(commList)
						}),
					{ctor: '[]'});
		}
	});
var _fxmy$fxmygithubio$FxmyBody$LoadURLContent = function (a) {
	return {ctor: 'LoadURLContent', _0: a};
};
...
var _fxmy$fxmygithubio$FxmyHeader$delta2url = F2(
	function (modelOld, modelNew) {
		if (!_elm_lang$core$Native_Utils.eq(modelOld.tab_selected, modelNew.tab_selected)) {
			...
			return _elm_lang$core$Maybe$Just(
				{entry: _rgrempel$elm_route_url$RouteUrl$NewEntry, url: urlNew});
		} else {
			if (_elm_lang$core$Native_Utils.eq(modelNew.tab_selected, 0) && (!_elm_lang$core$Native_Utils.eq(
				_fxmy$fxmygithubio$FxmyBody$get_content_url(modelOld.body),
				_fxmy$fxmygithubio$FxmyBody$get_content_url(modelNew.body)))) {
				var urlNew = A2(
					_elm_lang$core$Basics_ops['++'],
					'#',
					_fxmy$fxmygithubio$FxmyBody$get_content_url(modelNew.body));
...
var _fxmy$fxmygithubio$FxmyHeader$Model = F4(
	function (a, b, c, d) {
		return {header_content: a, mdl: b, tab_selected: c, body: d};
	});
var _fxmy$fxmygithubio$FxmyHeader$DisplayTab = function (a) {
	return {ctor: 'DisplayTab', _0: a};
};
var _fxmy$fxmygithubio$FxmyHeader$BodyMsg = function (a) {
	return {ctor: 'BodyMsg', _0: a};
};
var _fxmy$fxmygithubio$FxmyHeader$view_blog = function (model) {
	return A2(_fxmy$fxmygithubio$FxmyBody$render, _fxmy$fxmygithubio$FxmyHeader$BodyMsg, model.body);
};
var _fxmy$fxmygithubio$FxmyHeader$view_main = function (model) {
	var _p1 = model.tab_selected;
	switch (_p1) {
		case 0:
			return _fxmy$fxmygithubio$FxmyHeader$view_blog(model);
		case 1:
			return _fxmy$fxmygithubio$FxmyHeader$view_about(model);
		default:
			return A2(
				_elm_lang$html$Html$h3,
				{
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('404 UCCU σ`∀´)'),
					_1: {ctor: '[]'}
				});
	}
};
var _fxmy$fxmygithubio$FxmyHeader$update = F2(
	function (msg, model) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'SelectTab':
				if (_p2._0 === 0) {
					var bodyNew = A2(_fxmy$fxmygithubio$FxmyBody$set_content_url, model.body, 'blog');
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{tab_selected: 0, body: bodyNew}),
						{
							ctor: '::',
							_0: A2(
								_elm_lang$core$Platform_Cmd$map,
								_fxmy$fxmygithubio$FxmyHeader$BodyMsg,
								_fxmy$fxmygithubio$FxmyBody$get_content(bodyNew)),
							_1: {ctor: '[]'}
						});
				} else {
					return A2(
			...
			default:
				var _p3 = A2(_fxmy$fxmygithubio$FxmyBody$update, _p2._0, model.body);
				var newBodyModel = _p3._0;
				var bodyCmd = _p3._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
					...
					{
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _fxmy$fxmygithubio$FxmyHeader$BodyMsg, bodyCmd),
						_1: {ctor: '[]'}
					});
		}
	});
...
var _fxmy$fxmygithubio$FxmyHeader$location2messages = function (location) {
	var _p4 = A2(_elm_lang$core$String$dropLeft, 1, location.hash);
	switch (_p4) {
		case '':
			return {
				ctor: '::',
		...
		case 'about':
			return {
				ctor: '::',
				_0: _fxmy$fxmygithubio$FxmyHeader$SelectTab(1),
				_1: {ctor: '[]'}
			};
		default:
			return {
				...
				_0: _fxmy$fxmygithubio$FxmyHeader$BodyMsg(
					_fxmy$fxmygithubio$FxmyBody$LoadURLContent(_p4)),
				_1: {
					ctor: '::',
					_0: _fxmy$fxmygithubio$FxmyHeader$DisplayTab(0),
					_1: {ctor: '[]'}
				}
			};
	}
};
var _fxmy$fxmygithubio$FxmyHeader$Mdl = function (a) {
...
var _fxmy$fxmygithubio$FxmyHeader$main = _rgrempel$elm_route_url$RouteUrl$program(
	{
		delta2url: _fxmy$fxmygithubio$FxmyHeader$delta2url,
		location2messages: _fxmy$fxmygithubio$FxmyHeader$location2messages,
		init: {ctor: '_Tuple2', _0: _fxmy$fxmygithubio$FxmyHeader$initModel, _1: _elm_lang$core$Platform_Cmd$none},
		view: _fxmy$fxmygithubio$FxmyHeader$view,
		update: _fxmy$fxmygithubio$FxmyHeader$update,
		subscriptions: _fxmy$fxmygithubio$FxmyHeader$subscriptions
	})();

var Elm = {};
Elm['FxmyHeader'] = Elm['FxmyHeader'] || {};
if (typeof _fxmy$fxmygithubio$FxmyHeader$main !== 'undefined') {
    _fxmy$fxmygithubio$FxmyHeader$main(Elm['FxmyHeader'], 'FxmyHeader', undefined);
}
